...
public class NumberOfDifferentIntegersInAString {
    ...
    public static void main(String[] args) {
        ...
        int numberDifferentIntegers = numberDifferentIntegers(word);

        System.out.println(numberDifferentIntegers);
    }

    private static int numberDifferentIntegers(String word) {
